...
using HarmonyLib;
using UniLinq;
using static VoidGags.VoidGags.ZombiesFriendlyFire;
    ...
    public partial class VoidGags : IModApi
    {
        public void ApplyPatches_ZombiesFriendlyFire()
        {
            ...
            Harmony.Patch(AccessTools.Method(typeof(EntityAlive), nameof(EntityAlive.DamageEntity)),
                transpiler: new HarmonyMethod(EntityAlive_DamageEntity.Transpiler));
        }

        public static class ZombiesFriendlyFire
        {
            /// <summary>
