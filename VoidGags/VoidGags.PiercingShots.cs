...
using static VoidGags.VoidGags.PiercingShots;
    ...
    public partial class VoidGags : IModApi
    {
        public void ApplyPatches_PiercingShots()
        {
            ...
            Harmony.Patch(AccessTools.Method(typeof(ItemActionRanged), nameof(ItemActionRanged.fireShot)),
                prefix: new HarmonyMethod(ItemActionRanged_fireShot.Prefix));

            Harmony.Patch(AccessTools.Method(typeof(ProjectileMoveScript), nameof(ProjectileMoveScript.checkCollision)),
                prefix: new HarmonyMethod(ProjectileMoveScript_checkCollision.Prefix));
        }

        public static class PiercingShots
        {
            /// <summary>
            /// Bullets can break weak blocks and hit objects behind.
            /// </summary>
            public static class ItemActionRanged_fireShot
            {
                public static void Prefix(ItemActionRanged __instance, int _shotIdx, ItemActionDataRanged _actionData)
                {
                    ...
                    int hitMask = (__instance.hitmaskOverride == 0) ? 8 : __instance.hitmaskOverride;
            ...
            /// </summary>
            public static class ProjectileMoveScript_checkCollision
            {
                ...
                public static bool Prefix(ProjectileMoveScript __instance, bool ___isOnIdealPos, Vector3 ___idealPosition, Vector3 ___previousPosition, int ___hitMask, float ___radius, Entity ___firingEntity)
                {
                    ...
                    if (__instance.itemValueLauncher == null || __instance.itemValueLauncher.ItemClass == null || !__instance.itemValueLauncher.ItemClass.ItemTags.Test_AnySet(ArrowsBoltsDistraction.PerkArcheryTag))
                    {
                        return true;
                    }
                    ...
                    */
                    ...
                    var ray = new Ray(___previousPosition, vector2.normalized);
                ...
                {
                    Helper.DeferredAction(0.05f, () => SkipOriginalMethod = false);
                }
            }
        }
    }
